...
BASE_FIELDS = [
    ...
    "signal_frequency_hz", "signal_peak_speed_mps", "signal_amplitude_m", "signal_phase_rad", "signal_envelope", "signal_input", "analysis_valid",
...
class CrazyflieHover(Node):
    def __init__(self, node_name="crazyflie_hover", uri="radio://0/80/2M/E7E7E7E7E7", odom_topic="optitrack/odom2", csv_prefix="crazyflie_hover"):
        super().__init__(node_name)
        self.uri = uri
        self.odom_topic = odom_topic
        self.hover_z = 0.6
        self.hover_duration = 240.0
        ...
        self.csv_path = f"{csv_prefix}_{datetime.now():%Y%m%d_%H%M%S}.csv"
